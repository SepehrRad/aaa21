...
def add_time_interval(df):
    ...
    df.loc[df['Trip End Hour'].between(11, 17, inclusive='left'), 'Drop-off Time_Interval'] = 'midday'
    df.loc[df['Trip End Hour'].between(17, 23, inclusive='left'), 'Drop-off Time_Interval'] = 'evening'
    df.loc[((df['Trip End Hour'] >= 23) | (df['Trip End Hour'] < 5)), 'Drop-off Time_Interval'] = 'night'
